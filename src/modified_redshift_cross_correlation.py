...
def redshift_estimate_for_z(flux, wl, temp_flux, temp_wl, wl_min, wl_max, num_points=20000):
    """ 
    ...
    template_flux_log = resample_to_log_wavelength(wl, temp_flux, log_wl_grid)
